...
Namespace Migrations
    Public NotInheritable Partial Class AdicionadoCategoria
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AdicionadoCategoria))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201304261554100_AdicionadoCategoria"
            End Get
        End Property
